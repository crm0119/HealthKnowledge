...
public class news3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_news3, container, false);
        okHttpClient = new OkHttpClient();
        getData();
        recyclerView=view.findViewById(R.id.news3_vp);
        return view;
    }
    ...
    private void getData() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Request request = new Request.Builder().url(constans.WEB_TOP+constans.WEB_guoji).build();
