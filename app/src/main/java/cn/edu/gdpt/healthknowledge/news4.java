...
public class news4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_news4, container, false);
        okHttpClient = new OkHttpClient();
        getData();
        recyclerView=view.findViewById(R.id.news4_vp);
        return view;
    }
    ...
    private void getData() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Request request = new Request.Builder().url(constans.WEB_TOP+constans.WEB_yule).build();
